...
function Disclaimer() {
  return (
    <article className="disclaimer">
      ...
      <p>
        It is recommended to participate with adequate protection. Helmets,
        pads, and eye protection is highly recommended. The event will not be
        supplying helmets, pads, or medical assistance, and it is expected that
